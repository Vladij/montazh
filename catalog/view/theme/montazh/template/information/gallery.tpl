...
<div class="container mt-4">
    <p class="path">Главная / Проекты / Типовой проект</p>
    <div class="row justify-content-center">
        <h1 class="font-weight-bold mb-5 text-center mt-5">Галерея наших работ</h1>
    </div>
...
<div class="container">
    <div class="row justify-content-center">
        <div class="col-10">
            ...
            <p class="galery_description mt-4">Mi velit mauris eget mauris nulla semper porttitor Mi velit mauris eget mauris nulla semper porttitor Mi velit mauris eget mauris nulla semper porttitor Mi velit mauris eget mauris nulla semper porttitor Mi velit mauris eget mauris nulla semper porttitor Mi velit mauris eget</p>
        </div>
    </div>
</div>
...
<div class="container galery">
    <div class="row justify-content-center">
        <div class="col-10">
            <h1 class="font-weight-bold mt-4 pt-4" style="font-size: 200%;">Характеристики</h1>
        </div>
    </div>

    <ul>
        <li class="row justify-content-center mt-3 characteristic">
            <div class="col-5 col-md-3">Общие параметры</div>
            <div class="col-0 col-md-6"></div>
            <div class="col-5 col-md-2 text-md-right">120 000</div>
        </li>
        <li class="row justify-content-center mt-3 characteristic">
            <div class="col-3 col-md-1">Тип</div>
            <div class="col-8 col-md-8"></div>
            <div class="col-5 col-md-2 text-md-right">120 000</div>
        </li>
        <li class="row justify-content-center mt-3 characteristic">
            <div class="col-5 col-md-2">Поддержка</div>
            <div class="col-0 col-md-7"></div>
            <div class="col-5 col-md-2 text-md-right">120 000</div>
        </li>
        <li class="row justify-content-center mt-3 characteristic">
            <div class="col-5 col-md-2">Стены</div>
            <div class="col-0 col-md-7"></div>
            <div class="col-5 col-md-2 text-md-right">120 000</div>
        </li>
        <li class="row justify-content-center mt-3 characteristic">
            <div class="col-5 col-md-2">Крыша</div>
            <div class="col-0 col-md-7"></div>
            <div class="col-5 col-md-2 text-md-right">120 000</div>
        </li>
    </ul>
    <div class="row mt-5 text-right price">
        ...
        <div class="col-12 col-md-4 col-lg-3 col-xl-4 text-center font-weight-bold"><p>от 1 500 000 руб</p></div>
    </div>
</div>
