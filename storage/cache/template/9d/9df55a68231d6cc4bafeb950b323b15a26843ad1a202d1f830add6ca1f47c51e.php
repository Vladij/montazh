...
class __TwigTemplate_0dd6c787b1b7bc777c8027ae618556acc8adaaff4c4348c7862e6e2d659188a1 extends \Twig\Template
{
    private $source;
    private $macros = [];
...
<div class=\"container\">
    ...
    <div class=\"shop-carousel\" id=\"productsbottom\">
        ...
        // line 132
        $context['_parent'] = $context;
        $context['_seq'] = twig_ensure_traversable(twig_get_attribute($this->env, $this->source, ($context["data"] ?? null), "productsbottom", [], "any", false, false, false, 132));
...
<script>
    \$(window).on('load', function(){
        \$.ajax({
            url: '/index.php?route=product/product/categoryProductsAjax',
            type: 'GET',
            dataType: 'html'
        }).done(function (htmlData) {
            \$('body #productsbottom').html(htmlData);
