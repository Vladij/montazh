...
class __TwigTemplate_a2b4121a90b18aad518c91b8b34e4f4439177e386c5fc72456276d848e06bf64 extends \Twig\Template
{
    private $source;
    private $macros = [];
       ...
       \$('body #categories button').on('click', function(e){
          ...
          \$.ajax({
             ...
             \$.each(data.products, function (i, item){
                 \$('body #productsbottom #appended_' + i + '').remove();
              var html = '<div class=\"col-12 col-lg-4 mt-5\" id=\"appended_' + i + '\">' +
                  ...
                  '</div>';
              // if(i > 5) {
                  \$('body #productsbottom').slick('slickAdd', html + i);
              // }else{
                  // \$('.shop-carousel').slick('unslick');
                  // \$('body #productsbottom').append(html).slick('slickAdd', html);
              // }
...
";
    ...
    {
        return array (  346 => 175,  300 => 131,  297 => 130,  284 => 128,  279 => 127,  277 => 126,  264 => 115,  258 => 112,  252 => 108,  249 => 107,  246 => 106,  238 => 103,  229 => 100,  224 => 98,  221 => 97,  217 => 96,  209 => 91,  205 => 89,  200 => 88,  198 => 87,  188 => 80,  171 => 65,  168 => 64,  159 => 62,  151 => 60,  145 => 59,  143 => 58,  126 => 43,  123 => 42,  120 => 41,  108 => 35,  102 => 32,  96 => 29,  90 => 25,  85 => 24,  82 => 23,  74 => 18,  69 => 15,  66 => 14,  64 => 13,  56 => 7,  47 => 5,  43 => 4,  37 => 1,);
    }
