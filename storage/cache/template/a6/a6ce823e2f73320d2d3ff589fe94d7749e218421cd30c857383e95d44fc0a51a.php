...
class __TwigTemplate_081cf5262aa90835d0e7ccdafe6165d8d1c78daaeeaab8580fea28f0459cdfa4 extends \Twig\Template
{
    private $source;
    private $macros = [];
...
<script>
  \$(document).ready(function(){
    if(\$('body #services_modal #right_panel .bigblock').attr('status', 'hidden')){
      \$(this).hide();
    }else{
      \$(this).show();
    }
