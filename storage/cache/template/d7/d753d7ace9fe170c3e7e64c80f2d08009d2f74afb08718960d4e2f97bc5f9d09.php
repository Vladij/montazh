...
class __TwigTemplate_880a2b98aa2fc84b91198f96f79389359e6f33121863fcf4de79a904319da3d1 extends \Twig\Template
{
    private $source;
    private $macros = [];
  ...
  <div id=\"left_panel\">
    ";
        ...
        foreach ($context['_seq'] as $context["key"] => $context["category"]) {
            // line 142
            echo "    <div id=\"block\" block-id=\"block_";
            echo $context["key"];
            echo "\" ";
            if (($context["key"] == 0)) {
                echo " class=\"active\" ";
    ...
    ";
        ...
        foreach ($context['_seq'] as $context["key"] => $context["category"]) {
            ...
            if (twig_get_attribute($this->env, $this->source, $context["category"], "subcategories", [], "any", false, false, false, 155)) {
                ...
                echo "      ";
                $context['_parent'] = $context;
                $context['_seq'] = twig_ensure_traversable(twig_get_attribute($this->env, $this->source, $context["category"], "subcategories", [], "any", false, false, false, 156));
      ...
      <table>
        ...
        $context = array_intersect_key($context, $_parent) + $_parent;
        // line 196
        echo "    <div id=\"terrace\" status=\"hidden\">
...
";
    ...
    {
        return array (  340 => 239,  296 => 196,  290 => 195,  287 => 194,  245 => 158,  236 => 157,  231 => 156,  228 => 155,  224 => 154,  219 => 151,  212 => 149,  206 => 145,  204 => 144,  200 => 143,  191 => 142,  187 => 141,  58 => 15,  40 => 2,  37 => 1,);
    }
