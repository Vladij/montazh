...
class __TwigTemplate_9651c4ca916deaf8641bd508da7084930274385ea288c2393102ec5db71f79ba extends \Twig\Template
{
    private $source;
    private $macros = [];
...
<script>
  \$(document).ready(function(){
    \$('body #services_modal #left_panel').on('click', '#block', function(){
      \$(this).toggleClass('active');
      var blockId = \$(this).attr('block-id');
      var bigblock = \$(this).closest('#services_modal').find(blockId);
      bigblock.attr('status', 'showed');
    });
  });
</script>
