...
class __TwigTemplate_adbabdaef3d48e9708b985ef2fa0db9ba5fe4bd0b0dc90d5aabea0d91bd45fc8 extends \Twig\Template
{
    private $source;
    private $macros = [];
...
<script>
    \$(document).ready(function(){
       \$('body #categories button').on('click', function(e){
          e.preventDefault();
          \$.ajax({
              url : '<?php echo \$this->model_catalog_product->getCategoryProductsAjax(59); ?>',
              type : 'GET',
              // dataType : 'json',
          }).done(function(data){
              console.log(data);
